...
const AllBlogs = () => {
  ...
  const blogsUrl = "https://bit-craft-backend-main.vercel.app/blogposts";
  ...
  const filterByInput = `https://bit-craft-backend-main.vercel.app/searchInput/${searchInput}`;
  // click handler
  ...
  // filter by category
  const filterByCategory = `https://bit-craft-backend-main.vercel.app/category/${categories}`;
